...
/**
 * @brief Creates a variable representing that the edge (@p node1, @p node2)
 * has translator number @p number. The variable name will always start with the
 * smaller node.
 *
 ...
 * @return Z3_ast The lowest variable in lexicographic order among [(@p node1,
